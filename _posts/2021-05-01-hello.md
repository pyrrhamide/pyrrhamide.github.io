...
The `_config.yml` file in the root of the repo serves to globally define the site (I believe there is a fancier way to say this, however I cannot think of it right now).
